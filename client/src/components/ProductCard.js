...
const ProductCard = ({ product }) => {
  ...
  return (
    <Link
      to={`product/${product?._id}`}
      className="w-full max-w-[270px] md:w-[270px] h-auto rounded-lg shadow-md border flex flex-col mx-auto p-4 transition-transform duration-300 hover:scale-105 md:hover:scale-105"
    >
